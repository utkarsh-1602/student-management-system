                    ...
                    <div className="form-group">
                        ...
                        <div className="form-body">
                            ...
                            <div className="form-group row">
                                <label for="name" className="label-title col-sm-2">Name:</label>
                                <input type="text" id="name" className="form-input col-md-6" placeholder="enter student name" required="required" value={props.name} onChange={(e) => props.setName(e.target.value)} />
                            </div>


                            <div className="form-group row">
                                <label for="fathersName" className="label-title col-sm-2">Father's Name:</label>
                                <input type="text" id="fathersName" className="form-input col-md-6" placeholder="enter Father's Name" required="required" value={props.fathersName} onChange={(e) => props.setFathersName(e.target.value)} />
                            </div>



                            <div className="form-group row">
                                <label for="mothersName" className="label-title col-sm-2">Mothers's Name:</label>
                                <input type="text" id="mothersName" className="form-input col-md-6" placeholder="enter Mother's Name" required="required" value={props.mothersName} onChange={(e) => props.setMothersName(e.target.value)} />
                            </div>


                            <div className="form-group row">
                                <label for="age" className="label-title col-sm-2">Age:</label>
                                <input type="number" id="age" className="form-input col-md-6" placeholder="enter age" required="required" value={props.age} onChange={(e) => props.setAge(e.target.value)} />
                            </div>


                            <div className="form-group row">
                                <label for="homeAddress" className="label-title col-sm-2">Home Address: </label>
                                <input type="text" id="homeAddress" className="form-input col-md-6" placeholder="Enter Home Address" required="required" value={props.homeAddress} onChange={(e) => props.setHomeAddress(e.target.value)} />
                            </div>

                            
                            <div className="form-group row">
                                <label for="rollNumber" className="label-title col-sm-2">Roll Number:  </label>
                                <input type="number" id="rollNumber" className="form-input col-md-6" placeholder="Enter Student's Roll Number" required="required" value={props.rollNumber} onChange={(e) => props.setRollNumber(e.target.value)} />
                            </div>
                            ...
                            {/* row email */}
                            {/* <div className="form-group row">
                                <label for="firstname" className="label-title col-sm-2">Email:</label>
